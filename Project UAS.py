...
entry_input_emotion.insert(0, " ") 

# PERBAIKAN V5: Menggunakan padx maksimal (40)
btn_predict = tk.Button(input_emotion_frame, text="PREDIKSI", font=("Arial", 12, "bold"), 
...
entry_input_title.insert(0, " ")

# PERBAIKAN V5: Font diseragamkan ke 12, dan menggunakan padx maksimal (40)
